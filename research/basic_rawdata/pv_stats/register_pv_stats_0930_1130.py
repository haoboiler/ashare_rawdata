#!/usr/bin/env python3
"""Register the price-volume stats bundle for the 09:30-11:30 window.

Bundle 2: pv_stats_0930_1130
- Input: close, volume, amount (from 1m bars)
- Output: 15 variables covering TWAP/VWAP, price-volume relationships,
  and volume/amount statistics. Supersedes the pilot twap/vwap bundle.
...
OUTPUT_NAMES = [
    ...
    # --- 量价关系 (7) ---
    "amihud_0930_1130",
    "price_volume_corr_0930_1130",
    "return_volume_corr_0930_1130",
    "volume_imbalance_0930_1130",
    "amount_imbalance_0930_1130",
    "vwap_deviation_0930_1130",
    "kyle_lambda_0930_1130",
    # --- 成交量统计 (5) ---
    "volume_std_0930_1130",
    "volume_cv_0930_1130",
    "volume_skew_0930_1130",
    "volume_concentration_0930_1130",
    "volume_trend_0930_1130",
    # --- 成交额统计 (1) ---
    "amount_cv_0930_1130",
]
...
def apply_func(inputs):
    ...
    # Simple OLS: slope = cov(x,y) / var(x) where x=volume, y=|delta_price|
    if n_ret > 0:
        sx = 0.0
        sy = 0.0
        sxx = 0.0
...
def build_definition() -> AShareRawDataDefinition:
    return AShareRawDataDefinition(
        ...
        expected_bars=80,
        description=(
            "Price-volume stats bundle for the 09:30-11:30 window. "
            ...
            "and amount CV. Supersedes pilot_twap_vwap_0930_1130_v1."
        ),
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build or register the price-volume stats 09:30-11:30 bundle"
    )
    parser.add_argument(
        "--register",
        action="store_true",
