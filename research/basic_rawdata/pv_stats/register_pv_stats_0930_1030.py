#!/usr/bin/env python3
"""Register the price-volume stats bundle for the 09:30-10:30 window.

Bundle 2: pv_stats_0930_1030
...
OUTPUT_NAMES = [
    ...
    # --- 量价关系 (7) ---
    "amihud_0930_1030",
    "price_volume_corr_0930_1030",
    "return_volume_corr_0930_1030",
    "volume_imbalance_0930_1030",
    "amount_imbalance_0930_1030",
    "vwap_deviation_0930_1030",
    "kyle_lambda_0930_1030",
    # --- 成交量统计 (5) ---
    "volume_std_0930_1030",
    "volume_cv_0930_1030",
    "volume_skew_0930_1030",
    "volume_concentration_0930_1030",
    "volume_trend_0930_1030",
    # --- 成交额统计 (1) ---
    "amount_cv_0930_1030",
]
...
def build_definition() -> AShareRawDataDefinition:
    return AShareRawDataDefinition(
        ...
        expected_bars=40,
        description=(
            "Price-volume stats bundle for the 09:30-10:30 window. "
            ...
            "and amount CV. Supersedes pilot_twap_vwap_0930_1030_v1."
        ),
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build or register the price-volume stats 09:30-10:30 bundle"
    )
    parser.add_argument(
        "--register",
        action="store_true",
