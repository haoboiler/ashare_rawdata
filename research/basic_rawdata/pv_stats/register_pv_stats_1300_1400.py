#!/usr/bin/env python3
"""Register the price-volume stats bundle for the 13:00-14:00 window.

Bundle 2: pv_stats_1300_1400
...
OUTPUT_NAMES = [
    ...
    # --- 量价关系 (7) ---
    "amihud_1300_1400",
    "price_volume_corr_1300_1400",
    "return_volume_corr_1300_1400",
    "volume_imbalance_1300_1400",
    "amount_imbalance_1300_1400",
    "vwap_deviation_1300_1400",
    "kyle_lambda_1300_1400",
    # --- 成交量统计 (5) ---
    "volume_std_1300_1400",
    "volume_cv_1300_1400",
    "volume_skew_1300_1400",
    "volume_concentration_1300_1400",
    "volume_trend_1300_1400",
    # --- 成交额统计 (1) ---
    "amount_cv_1300_1400",
]
...
def build_definition() -> AShareRawDataDefinition:
    return AShareRawDataDefinition(
        ...
        expected_bars=40,
        description=(
            "Price-volume stats bundle for the 13:00-14:00 window. "
            ...
            "and amount CV. Supersedes pilot_twap_vwap_1300_1400_v1."
        ),
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build or register the price-volume stats 13:00-14:00 bundle"
    )
    parser.add_argument(
        "--register",
        action="store_true",
