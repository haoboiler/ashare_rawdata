#!/usr/bin/env python3
"""Register the volatility bundle for the 09:30-10:30 window.

Bundle 1: volatility_0930_1030
...
NAME = "volatility_0930_1030"

OUTPUT_NAMES = [
    # --- 价格波动 (10) ---
    "price_std_0930_1030",
    "return_std_0930_1030",
    "realized_vol_0930_1030",
    "upside_vol_0930_1030",
    "downside_vol_0930_1030",
    "vol_asymmetry_0930_1030",
    "parkinson_vol_0930_1030",
    "garman_klass_vol_0930_1030",
    "price_range_0930_1030",
    "bar_avg_range_0930_1030",
    # --- 收益分布 (6) ---
    "window_return_0930_1030",
    "return_skew_0930_1030",
    "return_kurt_0930_1030",
    "max_return_0930_1030",
    "min_return_0930_1030",
    "max_drawdown_0930_1030",
    # --- 微观结构 (4) ---
    "trend_strength_0930_1030",
    "autocorr_1_0930_1030",
    "sign_change_ratio_0930_1030",
    "close_position_0930_1030",
]
...
def build_definition() -> AShareRawDataDefinition:
    return AShareRawDataDefinition(
        ...
        expected_bars=40,
        description=(
            "Volatility bundle for the 09:30-10:30 window. "
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build or register the volatility 09:30-10:30 bundle"
    )
    parser.add_argument(
        "--register",
        action="store_true",
