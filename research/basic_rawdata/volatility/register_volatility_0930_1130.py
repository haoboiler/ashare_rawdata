#!/usr/bin/env python3
"""Register the volatility bundle for the 09:30-11:30 window.

Bundle 1: volatility_0930_1130
...
NAME = "volatility_0930_1130"

OUTPUT_NAMES = [
    # --- 价格波动 (10) ---
    "price_std_0930_1130",
    "return_std_0930_1130",
    "realized_vol_0930_1130",
    "upside_vol_0930_1130",
    "downside_vol_0930_1130",
    "vol_asymmetry_0930_1130",
    "parkinson_vol_0930_1130",
    "garman_klass_vol_0930_1130",
    "price_range_0930_1130",
    "bar_avg_range_0930_1130",
    # --- 收益分布 (6) ---
    "window_return_0930_1130",
    "return_skew_0930_1130",
    "return_kurt_0930_1130",
    "max_return_0930_1130",
    "min_return_0930_1130",
    "max_drawdown_0930_1130",
    # --- 微观结构 (4) ---
    "trend_strength_0930_1130",
    "autocorr_1_0930_1130",
    "sign_change_ratio_0930_1130",
    "close_position_0930_1130",
]
...
def build_definition() -> AShareRawDataDefinition:
    return AShareRawDataDefinition(
        ...
        expected_bars=80,
        description=(
            "Volatility bundle for the 09:30-11:30 window. "
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build or register the volatility 09:30-11:30 bundle"
    )
    parser.add_argument(
        "--register",
        action="store_true",
